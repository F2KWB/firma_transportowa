      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {team.map((person, index) => (
            <div
              key={index}
              className="group bg-gray-50 p-8 rounded-[2.5rem] border border-transparent hover:border-red-600 hover:bg-white hover:shadow-2xl transition-all duration-500 flex flex-col justify-between"
            >
              <div>
                <div className="flex justify-between items-start mb-6">
                  <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm group-hover:bg-red-600 transition-colors duration-500">
                ...
                <div className="mb-8">
                  ...
                  <h4 className="text-3xl font-black uppercase italic leading-none mb-3 group-hover:text-red-600 transition-colors">
                    {person.name}
                  </h4>
                  {person.subRole && (
                ...
                <div className="space-y-3">
                  ...
                  <a
                    ...
                    className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100 hover:border-red-600 hover:scale-[1.02] transition-all group/btn"
                  >
                    ...
                    <span className="font-black text-black italic text-sm">
                      {person.kom}
                    </span>
                  </a>
                  ...
                  {person.tel && (
                    <a
                      ...
                      className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100 hover:border-red-600 hover:scale-[1.02] transition-all"
                    >
                      <div className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100 hover:bg-red-600 hover:border-red-600 transition-all group/mail"
                  >

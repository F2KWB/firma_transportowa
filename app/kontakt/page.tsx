      ...
      <section className="bg-black text-white pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center md:text-left">
          ...
          <p className="text-gray-400 max-w-2xl text-lg font-medium">
            Poznaj nasz zespół i wybierz najwygodniejszą formę kontaktu.
          </p>
        </div>
      </section>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        required
                        type="text"
                        className="w-full bg-white border border-gray-200 p-4 rounded-2xl focus:border-red-600 outline-none transition-all"
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      id="dept-select"
                      required
                      className="w-full bg-white border border-gray-200 p-4 rounded-2xl focus:border-red-600 outline-none transition-all font-bold italic appearance-none cursor-pointer"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="w-full bg-white border border-gray-200 p-4 rounded-2xl focus:border-red-600 outline-none transition-all resize-none"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-black text-white p-6 rounded-2xl font-black uppercase italic hover:bg-red-600 transition-all flex items-center justify-center gap-3 group"
                  >
                    Wyślij zapytanie{" "}
